...
import { adminComparisons } from '@/api/admin'
...
const { t } = useI18n()
const { items, loading, create, remove } = useAdminCrud<ComparisonDto>(adminComparisons)
...
<template>
  <div>
    <AdminPageHeader :title="t('admin.comparisons')">
      <template #actions>
